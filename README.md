...
- 🔭 Atualmente sou **Engenheiro de Software Júnior no Bradesco**, atuando principalmente com desenvolvimento frontend.
- 🅰️ Trabalho com **Angular** e **TypeScript** na construção e evolução de aplicações, implementação de novas funcionalidades e modernização de sistemas.
- ☕ Também possuo experiência com **Java** e **Spring Boot**, desenvolvimento de APIs e integrações entre frontend e backend.
- 🎓 Formado em **Análise e Desenvolvimento de Sistemas pela FECAP**, com formação técnica em Desenvolvimento de Sistemas pela **Etec Raposo Tavares**.
- 🚀 Busco evoluir continuamente meus conhecimentos em **Frontend, Angular, TypeScript e desenvolvimento Web**.
- 😄 **Pronome:** Ele/Dele  
...
[![Portfólio](https://img.shields.io/badge/Portfólio-00C853?style=for-the-badge&logo=googlechrome&logoColor=white)](https://hebertesteves.github.io)  
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/hebertesteves/)  
